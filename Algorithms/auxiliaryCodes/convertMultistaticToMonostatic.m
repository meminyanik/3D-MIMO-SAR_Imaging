...
function sarDataMonostatic = convertMultistaticToMonostatic(sarDataMultistatic,chirpParameters,xStepM,yStepM,zTarget,radarType,activeTx,activeRx)
% For wideband processing:
% -------------------------------------------------------------------------
% sarDataMultistatic: should be nChannel x yPointM x xPointM x nSample
...
% sarDataMono = convertMultistaticToMonostatic(sarDataMulti,[77e9,70.295e12,5000e3,4.66e-6],400/407,7.59/8,300,'IWR1443',[1 1 1],[1 1 1 1])
